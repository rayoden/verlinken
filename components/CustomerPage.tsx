  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-md mx-auto px-5 pt-12 pb-20">
          <div
            className={`text-center transition-all duration-700 ${
              loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
          >
            <div className="w-28 h-28 mx-auto mb-6 rounded-3xl bg-white flex items-center justify-center shadow-2xl shadow-black/40 overflow-hidden p-3">
              <img
                src="/logo.webp"
                alt="Top Job Bern"
          ...
          <div className="mt-10 space-y-4">
            {buttons.map((btn, i) => (
              ...
              >
                <div
                  className={`rounded-2xl border backdrop-blur-md px-5 py-4 flex items-center gap-4 ${btn.bg} hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 shadow-lg ${
                    btn.label === "Auf Google bewerten" ? "gold-glow" : ""
                  }`}
                >
                  <div
                    className={`w-14 h-14 rounded-xl flex items-center justify-center shrink-0 ${btn.iconBg}`}
                  >
                    {btn.icon}
                  </div>
                  ...
                  <span className="text-xl opacity-50 group-hover:opacity-100 group-hover:translate-x-1 transition shrink-0">
                    →
                  </span>
                </div>
              </a>
          ...
          <div
            className={`mt-14 flex items-center justify-center gap-3 text-xs text-slate-500 transition-all duration-700 delay-700 ${
